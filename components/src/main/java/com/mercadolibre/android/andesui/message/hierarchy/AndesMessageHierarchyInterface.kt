...
internal object AndesLoudMessageHierarchy : AndesMessageHierarchyInterface() {
    ...
    override fun textColor() = R.color.andesui_white.toAndesColor()
    override fun dismissableIconColor() = R.color.andesui_white.toAndesColor()
...
internal object AndesQuietMessageHierarchy : AndesMessageHierarchyInterface() {
    override fun backgroundColor() = R.color.andesui_gray_040.toAndesColor()
    override fun backgroundColor(type: AndesMessageTypeInterface) = backgroundColor()
    override fun textColor() = R.color.andesui_gray_800.toAndesColor()
    override fun dismissableIconColor() = R.color.andesui_gray_450.toAndesColor()
    ...
    override fun secondaryActionTextColor(type: AndesMessageTypeInterface) = R.color.andesui_accent_color_500.toAndesColor()
}
