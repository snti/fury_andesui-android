...
class AndesMessageConfigurationQuiet {
    ...
    fun `Quiet, Neutral background color`() {
        attrs = AndesMessageAttrs(AndesMessageHierarchy.QUIET, AndesMessageType.NEUTRAL, "Body", "Title", true, null)
    ...
    fun `Quiet, Success background color`() {
        attrs = AndesMessageAttrs(AndesMessageHierarchy.QUIET, AndesMessageType.SUCCESS, "Body", "Title", true, null)
        val config = configFactory.create(context, attrs)
        assertEquals(config.backgroundColor, R.color.andes_gray_040.toAndesColor())
    }
    ...
    fun `Quiet, Error background color`() {
        attrs = AndesMessageAttrs(AndesMessageHierarchy.QUIET, AndesMessageType.ERROR, "Body", "Title", true, null)
        val config = configFactory.create(context, attrs)
        assertEquals(config.backgroundColor, R.color.andes_gray_040.toAndesColor())
    }
    ...
    fun `Quiet, Warning background color`() {
        attrs = AndesMessageAttrs(AndesMessageHierarchy.QUIET, AndesMessageType.WARNING, "Body", "Title", true, null)
        val config = configFactory.create(context, attrs)
        assertEquals(config.backgroundColor, R.color.andes_gray_040.toAndesColor())
    }
    ...
    fun `Quiet, Neutral null title text`() {
        attrs = AndesMessageAttrs(AndesMessageHierarchy.QUIET, AndesMessageType.NEUTRAL, "Body", null, true, null)
        val config = configFactory.create(context, attrs)
    ...
    fun `Quiet, Success null title text`() {
        attrs = AndesMessageAttrs(AndesMessageHierarchy.QUIET, AndesMessageType.SUCCESS, "Body", null, true, null)
        val config = configFactory.create(context, attrs)
        assertEquals(config.titleText, null)
    }
    ...
    fun `Quiet, Error null title text`() {
        attrs = AndesMessageAttrs(AndesMessageHierarchy.QUIET, AndesMessageType.ERROR, "Body", null, true, null)
        val config = configFactory.create(context, attrs)
        assertEquals(config.titleText, null)
    }
    ...
    fun `Quiet, Warning null title text`() {
        attrs = AndesMessageAttrs(AndesMessageHierarchy.QUIET, AndesMessageType.WARNING, "Body", null, true, null)
        val config = configFactory.create(context, attrs)
        assertEquals(config.titleText, null)
    }
