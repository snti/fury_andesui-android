...
class AndesMessageConfigurationLoudTest {
    ...
    fun `Loud, Neutral background color`() {
        attrs = AndesMessageAttrs(AndesMessageHierarchy.LOUD, AndesMessageType.NEUTRAL, "Body", "Title", true, null)
    ...
    fun `Loud, Success background color`() {
        attrs = AndesMessageAttrs(AndesMessageHierarchy.LOUD, AndesMessageType.SUCCESS, "Body", "Title", true, null)
        val config = configFactory.create(context, attrs)
    ...
    fun `Loud, Error background color`() {
        attrs = AndesMessageAttrs(AndesMessageHierarchy.LOUD, AndesMessageType.ERROR, "Body", "Title", true, null)
        val config = configFactory.create(context, attrs)
    ...
    fun `Loud, Warning background color`() {
        attrs = AndesMessageAttrs(AndesMessageHierarchy.LOUD, AndesMessageType.WARNING, "Body", "Title", true, null)
        val config = configFactory.create(context, attrs)
    ...
    fun `Loud, Neutral null title text`() {
        attrs = AndesMessageAttrs(AndesMessageHierarchy.LOUD, AndesMessageType.NEUTRAL, "Body", null, true, null)
        val config = configFactory.create(context, attrs)
    ...
    fun `Loud, Success null title text`() {
        attrs = AndesMessageAttrs(AndesMessageHierarchy.LOUD, AndesMessageType.SUCCESS, "Body", null, true, null)
        val config = configFactory.create(context, attrs)
        assertEquals(config.titleText, null)
    }
    ...
    fun `Loud, Error null title text`() {
        attrs = AndesMessageAttrs(AndesMessageHierarchy.LOUD, AndesMessageType.ERROR, "Body", null, true, null)
        val config = configFactory.create(context, attrs)
        assertEquals(config.titleText, null)
    }
    ...
    fun `Loud, Warning null title text`() {
        attrs = AndesMessageAttrs(AndesMessageHierarchy.LOUD, AndesMessageType.WARNING, "Body", null, true, null)
        val config = configFactory.create(context, attrs)
        assertEquals(config.titleText, null)
    }
    ...
    fun `Loud, Neutral primary action color`() {
        ...
        assertEquals(config.primaryActionBackgroundColor, BackgroundColorConfig(enabledColor = R.color.andes_accent_color_600.toAndesColor(),
